...
func _ready() -> void:
	...
	for _i in range(3):
		...
		turtle.append_turtle_actions(Turtle.DiveAction.new(120))


func _draw_line(mesh_instance: MeshInstance3D, pos1: Vector3, pos2: Vector3, color = Color.WHITE_SMOKE, persist_ms = 0):
...
func _on_turtle_finished_move(pos1: Vector3, pos2: Vector3) -> void:
	_draw_line(pathMeshInstance, pos1, pos2)
...
func _on_turtle_moving(current_pos: Vector3) -> void:
	...
	while turtle.is_moving:
		_draw_line(movingMeshInstance, current_pos, turtle.position)
